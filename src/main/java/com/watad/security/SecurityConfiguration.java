...
extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http ) throws Exception {
         ...
         .antMatchers("/restPass").permitAll()
         .antMatchers("/search/**").permitAll()
         .antMatchers("/getItemById/**").permitAll()
         .antMatchers("/getUserRole/**").permitAll()
         .antMatchers("/getItemPage/**").permitAll()
         .antMatchers("/marketPlace").permitAll()
         .antMatchers("/subCategory/**").permitAll()
         .antMatchers("/subImages/**").permitAll()
         .antMatchers("/items/**").permitAll()
         .antMatchers("/itemsInSuchCategoryAndSubCategory/**").permitAll()
         .antMatchers("/active/**").permitAll()
         .antMatchers("/findEmailByPhone").permitAll()
